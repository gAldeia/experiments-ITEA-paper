...
# ElNet is deterministic --- it doesn't need repetitions for each fold 
n_folds         = 5
...
fname = '../../results/rmse/elnet-resultsregression.csv'
...
for ds in datasets:
    ...
    for fold in range(n_folds):
        ...
        regressor = linear_model.ElasticNet(**grid.best_params_).fit(X_train, y_train)  
