...
# Lasso é determinístico, não precisamos fazer repetições
datasets = [
    'airfoil',
    'concrete',
    'energyCooling',
...
fname = '../docs/lasso-resultsregression.csv'
...
for ds in datasets:
    ...
    for fold in range(n_folds):
        ...
        regressor = linear_model.Lasso(**grid.best_params_).fit(X_train, y_train)  
